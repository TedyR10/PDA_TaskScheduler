...
//                new Test(2, SchedulingAlgorithm.LEAST_WORK_LEFT, 15, "LWL_Test4", 10),
    ...
    private static int runTest(Test test) {
        ...
        File[] dir =
                new File("/home/student/Desktop/APD/tema2/checker/in" + File.separator + test.inFolder).listFiles();
        if (dir != null) {
            for (File input : dir) {
        ...
        try {
            String output =
                    new Scanner(new File("/home/student/Desktop/APD/tema2/checker/in" + File.separator + test.inFolder + File.separator + "out")).useDelimiter("\\Z").next();
